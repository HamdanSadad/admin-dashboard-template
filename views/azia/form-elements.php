...
<script src="<?= base_url('assets/azia/lib/jquery-ui/ui/widgets/datepicker.js') ?>"></script>
...
<script src="<?= base_url('assets/azia/lib/jquery.maskedinput/jquery.maskedinput.js') ?>"></script>
<script src="<?= base_url('assets/azia/lib/spectrum-colorpicker/spectrum.js') ?>"></script>
<script src="<?= base_url('assets/azia/lib/select2/js/select2.min.js') ?>"></script>
<script src="<?= base_url('assets/azia/lib/ion-rangeslider/js/ion.rangeSlider.min.js') ?>"></script>
<script src="<?= base_url('assets/azia/lib/amazeui-datetimepicker/js/amazeui.datetimepicker.min.js') ?>"></script>
<script src="<?= base_url('assets/azia/lib/jquery-simple-datetimepicker/jquery.simple-dtpicker.js') ?>"></script>
<script src="<?= base_url('assets/azia/lib/pickerjs/picker.min.js') ?>"></script>
