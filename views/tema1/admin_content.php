                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <img
                                                ...
                                                src="/assets/3tema/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg end">
                                            ...
                                            <img
                                                class="direct-chat-img"
                                                src="/assets/3tema/img/user3-128x128.jpg"
                                                alt="message user image" />
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="/assets/3tema/img/user7-128x128.jpg"
                                                        alt="User Avatar" />
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="/assets/3tema/img/user5-128x128.jpg"
                                                        alt="User Avatar" />
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="/assets/3tema/img/user6-128x128.jpg"
                                                        alt="User Avatar" />
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="/assets/3tema/img/user8-128x128.jpg"
                                                        alt="User Avatar" />
