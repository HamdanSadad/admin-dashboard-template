                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="<?= base_url($dashboardPath) ?>" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="<?= base_url('assets/'.$THEME.'/images/logo-sm.svg'); ?>" alt="" height="24"> <span class="logo-txt">Minia</span>
                                </span>
                            </a>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?= base_url('assets/'.$THEME.'/images/users/avatar-1.jpg'); ?>"
                                    alt="Header Avatar">
