<aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="<?= base_url('assets/' . $THEME . '/images/logo-icon-2.png'); ?>" class="logo-icon" alt="logo icon">
        </div>
        <div>
