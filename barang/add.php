...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$error) {
        $stmt = mysqli_prepare($connection, "INSERT INTO `barang` (kode_barang, nama_barang, harga) VALUES (?, ?, ?)");
        mysqli_stmt_bind_param($stmt, "ssd", $kode_barang_post, $nama_barang_post, $harga_post);
